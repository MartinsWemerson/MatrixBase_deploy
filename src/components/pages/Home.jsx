...
export const Home = () => {
  return (
    <main>
      <section>
        <section>
         <img src={Principal} alt="servideos" title='Centro de Servidores' className='sm:w-full h-36 sm:h-full'  />
          ...
          <p className=' text-green-950 p-10 text-bold  font-medium text-center'> matrixBase é uma plataforma inovadora que revoluciona a maneira como as empresas lidam com seus dados. Com uma combinação de tecnologias avançadas e uma interface intuitiva, o matrixBase oferece soluções abrangentes para gerenciar, consultar e otimizar bancos de dados</p>
        </section>
